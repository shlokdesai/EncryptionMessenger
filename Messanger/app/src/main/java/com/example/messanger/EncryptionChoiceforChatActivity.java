...
public class EncryptionChoiceforChatActivity extends ChatListActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_encryption_choicefor_chat);
        ...
        none.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EncryptionChoiceforChatActivity.this, MessageActivity.class);
